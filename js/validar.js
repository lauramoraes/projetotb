 ...
 */
 ...
 function returnNameCampoTriagem (name)
 {
	...
	tabela_triagem[100] = ["cicatrizBCG", "39 - Cicatriz de BCG"];
	tabela_triagem[101] = ["resultadoLeitura", "38.3 - Resultado da leitura"];
	tabela_triagem[102] = ["data_aplicacao", "38.4 - Data de aplicação da prova tuberculínica"];
	tabela_triagem[103] = ["data_leitura", "38.5 - Data da Leitura"];
	tabela_triagem[104] = ["PTprimeiraDose", "38.6 - PT 1ª dose leitor"];
	tabela_triagem[105] = ["observacoes", "40 - Observações"];
...
function validarCustos(form, data)
{
 ...
 function returnNameCampoConsultaMedica (name)
 {
	...
	tabela_consulta_medica[16] = ["desfechoQuimio", "02.4 - Desfecho:"];
	tabela_consulta_medica[17] = ["testeHIV", "03 - HIV teste:"];
	tabela_consulta_medica[18] = ["dia_antihiv", "04 - Data do anti-HIV:"];
	tabela_consulta_medica[19] = ["exameFisico", "06 - Exame físico normal:"];
	tabela_consulta_medica[20] = ["alteracoesNoExameFisico", "06.1 - Descreva as alterações:"];
	tabela_consulta_medica[21] = ["probTBativa", "07 - Probabilidade de TB ativa:"];
	tabela_consulta_medica[22] = ["porcentagemProbTBsemRXsemBAAR", "08 - Qual a probabilidade do diagnóstico de TB pulmonar ativa sem avaliar RX de tórax ou BAAR?"];
	tabela_consulta_medica[23] = ["probTBativaComRX", "09 - Probabilidade de TB ativa ao avaliar o RXT:"];
	tabela_consulta_medica[24] = ["cavitacao", "09.1 - Cavitação:"];
	tabela_consulta_medica[25] = ["padraoTipico", "09.2 - Padrão tópico (infiltrado em lobo(s) superior(es) e/ou segmento apical de lobo inferior):"];
	tabela_consulta_medica[26] = ["compativel", "09.3 - Compatível (alargamento mediastinal ou linf.  hilar , padrão miliar,ou derrame pleural):"];
	tabela_consulta_medica[27] = ["atipico", "09.4 - Atípico (qualquer outro padrão):"];
	tabela_consulta_medica[28] = ["nsa", "09.4 - Atípico (qualquer outro padrão):"];
	tabela_consulta_medica[29] = ["casoBaixaProbabilidade", "09.1 - Em caso de baixa probabilidade de TB ativa responda:"];
	tabela_consulta_medica[30] = ["dia_rx", "10 - Data do RX:"];
	tabela_consulta_medica[31] = ["diagnosticoProbabilidadeRX", "11 - Diagnóstico de probabilidade tendo informação sobre o RX de tórax mas sem conhecimento dos resultados bacteriológicos:"];
	tabela_consulta_medica[32] = ["probabilidadeTBcomRXsemBAAR", "12 - Qual a probabilidade do diagnóstico de TB pulmonar ativa com a avaliação do RX de tórax e sem o BAAR?"];
	tabela_consulta_medica[33] = ["diagnosticoProbabilidadeCasoDuasNegativas", "15 - Caso as duas baciloscopias iniciais sejam negativas, qual seria o diagnóstico de probabilidade de TB?"];
	tabela_consulta_medica[34] = ["probabilidadeTBcomRXcomBAAR", "16 - Qual a probabilidade do diagnóstico de TB pulmonar ativa com a avaliação do RX de tórax e do BAAR?"];
	tabela_consulta_medica[35] = ["desfechoConsultaInicial", "17 - Desfecho da consulta inicial:"];
	tabela_consulta_medica[36] = ["casoTratamentoTB", "18 - Em caso de tratamento para TB(marque qual):"];
	...
	tabela_consulta_medica[46] = ["casoPositivo2","14.1 - Se positivo (2):"];
	tabela_consulta_medica[47] = ["observacoes"," 20 - Observações: "];
	tabela_consulta_medica[48] = ["avaliador","Avaliado por: "];
	tabela_consulta_medica[49] = ["quemCadastrou","Cadastrado por: "];
	tabela_consulta_medica[50] = ["ano_quimio", "02.3 - Data da Quimioprofilaxia:"];
	tabela_consulta_medica[51] = ["mes_antihiv", "04 - Data do anti-HIV:"];
	tabela_consulta_medica[52] = ["ano_antihiv", "04 - Data do anti-HIV:"];
	tabela_consulta_medica[53] = ["comorbidade", "05 - Comorbidades:"];
	tabela_consulta_medica[54] = ["mes_rx", "10 - Data do RX:"];
	tabela_consulta_medica[55] = ["ano_rx", "10 - Data do RX:"];
	tabela_consulta_medica[56] = ["outrascomorbidades", "05 - Comorbidades: (campo Outras)"];
