...
int main (int argc, char **argv)
{
	...
	printf ("	tabFields[28] = [\"nsa\", \"09.4 - At&iacute;pico (qualquer outro padrão):\"];\n");
	...
	printf ("	tabFields[34] = [\"prob_tb_ativa_com_rx_baar\", \"16 - Qual a probabilidade do diagn&oacutestico de TB pulmonar ativa com a avalia&ccedil;&atilde;o do RX de t&oacute;rax e do BAAR?\"];\n");
	...
	printf ("	tabFields[42] = [\"ano_inclusao\",\"Data da consulta&nbsp;:&nbsp;\"];\n");
	...
	printf ("	{\n");
	printf ("		elemTabela = document.getElementById(tabela);\n");
	printf ("		elemTabela.rows[2].style.display = \"none\";//INH\n");
	printf ("		elemTabela.rows[3].style.display = \"none\";//RIF\n");
	printf ("		elemTabela.rows[4].style.display = \"none\";//esquema\n");
	/*
	...
	*/
	printf ("		elemTabela.rows[8].style.display = \"none\";//INH\n");
	printf ("		elemTabela.rows[9].style.display = \"none\";//RIF\n");
	printf ("		elemTabela.rows[10].style.display = \"none\";//data da quimio\n");
	printf ("		elemTabela.rows[11].style.display = \"none\";//desfecho\n");
	printf ("		elemTabela.rows[16].style.display = \"none\";//Comorbidades\n");
	printf ("		elemTabela.rows[17].style.display = \"none\";//Comorbidades\n");
	printf ("		elemTabela.rows[18].style.display = \"none\";//Comorbidades\n");
	printf ("		elemTabela.rows[19].style.display = \"none\";//Comorbidades\n");
	printf ("		elemTabela.rows[22].style.display = \"none\";//alteracao exame fixico\n");
	printf ("		elemTabela.rows[27].style.display = \"none\";//cavitacao\n");
	printf ("		elemTabela.rows[28].style.display = \"none\";//padrao topico\n");
	printf ("		elemTabela.rows[29].style.display = \"none\";//compativel\n");
	printf ("		elemTabela.rows[30].style.display = \"none\";//atipico\n");
	printf ("		elemTabela.rows[31].style.display = \"none\";//NSA\n");
	printf ("		elemTabela.rows[32].style.display = \"none\";//caso baixa probabilidade\n");
	printf ("		elemTabela.rows[33].style.display = \"none\";//caso baixa probabilidade\n");
	printf ("		elemTabela.rows[39].style.display = \"none\";//baar positivo\n");
	printf ("		elemTabela.rows[41].style.display = \"none\";//baar positivo\n");
	printf ("		elemTabela.rows[45].style.display = \"none\";//caso tratamento TB\n");
	printf ("		elemTabela.rows[46].style.display = \"none\";//fatores de risco para tbp mdr\n");
	printf ("		elemTabela.rows[47].style.display = \"none\";//fatores de risco para tbp mdr*\n");
	printf ("	}\n");
	printf ("\n");
